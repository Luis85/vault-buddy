...
const inList = (title: string, list: string, order: number): TaskItem => ({
  ...
  title, status: "new", created: "2026-07-08", done: false, due: null, scheduled: null, priority: null, tags: [], list, order, id: null, description: null, parentId: null, parentLink: null,
});
...
describe("manual reordering", () => {
  ...
  it("ignores a drag released over a non-target section like Done (Codex PR #59)", async () => {
    ...
    const done: TaskItem = {
      ...
      done: true, due: null, scheduled: null, priority: null, tags: [], list: "", order: null, id: null, description: null, parentId: null, parentLink: null,
    };
