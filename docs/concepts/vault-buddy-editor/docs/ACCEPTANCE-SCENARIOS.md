...
These are executable-specification inputs for implementation, **not assertions that all native behaviors have passed**. Map the full feature catalog into implementation tests. The browser test inventory and outcomes are separate under tests/. All scenarios are current-state requirements; no previous document set is needed.

## A01 — Correct native capture destination
...
## A03 — Non-destructive cut and reopen
...
## A06 — Monitoring is not export mute
...
## A10 — Resizing survives serialization
...
## A11 — Source-linked teaching cues
...
## A12 — Caption timing and correction
...
## A17 — Historical source dependency
...
## A19 — Safe missing-media reconnection
...
## A21 — Partial output publication
...
## A22 — Malicious project rejection
