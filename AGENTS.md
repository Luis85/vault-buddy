...
All 123 commands, registered in `src-tauri/src/lib.rs` (`generate_handler`).
...
123 after Task 48's `editor_publish_product`/`editor_export_subtitles`):
