...
| [docs/superpowers/specs/2026-09-18-screen-capture-windows-verification.md](docs/superpowers/specs/2026-09-18-screen-capture-windows-verification.md) | The screen-capture feature's manual Windows checklist — a RUNNING document across phases, not one phase's gate. It carries rows 1–41 today (plus 27a and 27b) — the count is measured, not incremented. An empty Result column means unrun, which is not the same as failed. **The deferral is LIFTED**: the user began running it on 2026-09-21, batch by batch. Rows 1–10, 29 and 37–41 carry results; 11–28 and 30–36 are still unrun. Row 41 was added BY that pass, for a defect it found (GAP-164) |
