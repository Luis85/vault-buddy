...
All 113 commands, registered in `src-tauri/src/lib.rs` (`generate_handler`).
...
3. A grant in EXACTLY ONE capability file's `permissions` array:
   ...
   command is one of the `editor_*` commands (seventeen as of Task 36), otherwise
