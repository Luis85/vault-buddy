...
- **Screen capture** — the second capture provider (phases 2–5): record a
  ...
  tab in Vault settings for the seven per-vault fields. **All six phases are
...
│   │                           #     webcam_windows.rs), source_webcam (webcam enumeration),
