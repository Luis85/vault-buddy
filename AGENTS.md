...
│   │                           #     + redact.rs (redact_path/redact_name: the ONLY way an
│   │                           #     editor log line may carry a path or a name; its
│   │                           #     test-only redact_guard.rs scans every editor log call)
...
- **The tutorial editor (`src/components/editor/shell/`, Task 16, F-48)
  ...
  The dark theme's own shortfalls are GAP-209. **Forced colours** (Windows
