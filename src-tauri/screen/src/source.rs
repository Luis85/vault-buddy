...
//!
//! The PURE arithmetic that enumeration and resolution derive from a live
//! source (capture size, crop, monitor label) lives in `source_derive` and is
//! re-exported here; keep new derivations there, not in the `cfg(windows)` arm.
